...
function ProductCard({ id, image, title, price }: ProductType) {
  return (
    <Link
      href={`/product/${id}`}
      className="relative inline-flex flex-col items-center gap-2 p-1 overflow-hidden rounded-lg shadow-lg w-52">
      <div className="absolute top-0 right-0 flex items-center justify-center w-1/5 text-3xl text-white bg-green-800/70 rounded-ee-md h-1/6">
        +
      </div>
